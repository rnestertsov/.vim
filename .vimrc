" .vimrc
" This file is based on configuration done by Steve Losh <steve@stevelosh.com>
" with some mine modifications
...
call MakeSpacelessIabbrev('@@', 'rnestertsov@gmail.com')
...
" Apply config
nmap <silent> <leader>ac :so $MYVIMRC<CR>
...
" <m-j> and <m-k> to drag lines in normal & visual mode
noremap mj :m+<CR>
noremap mk :m-2<CR>
vnoremap mj :m'>+<CR>gv
